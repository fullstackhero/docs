...
pageType: guide
seo:
  title: 'FSH DbMigrator — EF Core migrations for a multi-tenant .NET'
  description: 'How fullstackhero applies database migrations: a dedicated one-shot DbMigrator that migrates the tenant catalog and every tenant module database as an…'
