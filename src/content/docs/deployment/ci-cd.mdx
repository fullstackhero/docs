...
pageType: reference
seo:
  title: 'CI/CD pipeline — GitHub Actions for a .NET 10 modular'
  description: 'How fullstackhero builds, tests, and ships in GitHub Actions: a parallel test matrix, DbMigrator container smoke, Testcontainers integration tests, an 80%…'
