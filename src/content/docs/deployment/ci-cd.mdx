...
seo:
  ...
  description: 'How fullstackhero builds, tests, and ships in GitHub Actions: path-scoped pipelines, Testcontainers tests, an 80% coverage gate, and container publishing.'
