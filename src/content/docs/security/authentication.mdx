...
seo:
  ...
  description: 'How fullstackhero handles authentication — ASP.NET Identity backed by JWT bearer tokens with rotating refresh, 5-attempt lockout, 12-character minimum…'
