...
seo:
  ...
  description: 'How fullstackhero supports operator impersonation — SuperAdmin start/end of impersonation grants, cross-tenant via IGlobalEntity, server-side revocation…'
