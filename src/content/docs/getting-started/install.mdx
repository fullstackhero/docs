...
pageType: guide
seo:
  title: 'Install fullstackhero — fsh CLI, dotnet new template, git'
  description: 'Four ways to install fullstackhero: the FullStackHero.CLI dotnet tool (recommended), the FullStackHero.NET.StarterKit dotnet new template, a direct git…'
