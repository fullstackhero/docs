...
seo:
  ...
  description: 'Tools you need before running fullstackhero locally: .NET 10 SDK, Docker (for Postgres + Redis), optional Node 20+ for the React frontends, and the .NET…'
