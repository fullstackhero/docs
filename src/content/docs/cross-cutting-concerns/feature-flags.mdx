...
pageType: concept
seo:
  title: 'Feature flags in .NET 10 - Microsoft.FeatureManagement'
  description: 'How fullstackhero wires Microsoft.FeatureManagement.AspNetCore with a custom TenantFeatureFilter so flags can be enabled per tenant - for staged rollouts…'
