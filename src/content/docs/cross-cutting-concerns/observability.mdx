...
seo:
  ...
  description: 'How fullstackhero wires Serilog 4 structured logging with HTTP-context enrichers, OpenTelemetry 1.15 traces (incl. Mediator pipeline) + metrics + logs via…'
