...
seo:
  ...
  description: 'How fullstackhero wires Microsoft.Extensions.Http.Resilience (Polly v8) to every named HttpClient — retry on transient failures, circuit breaker…'
