...
pageType: concept
seo:
  title: 'Rate limiting in .NET 10 — auth policy + ASP.NET Core'
  description: 'How fullstackhero wires Microsoft.AspNetCore.RateLimiting with the auth policy applied to login, refresh, forgot-password, reset-password, confirm-email…'
