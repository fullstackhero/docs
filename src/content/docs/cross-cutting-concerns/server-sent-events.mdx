...
seo:
  ...
  description: 'How fullstackhero exposes a small SSE endpoint scaffold for one-way streaming use cases — live audit log tail, usage gauge updates, build status feeds…'
