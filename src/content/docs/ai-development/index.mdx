...
pageType: concept
seo:
  title: 'AI-Driven Development with fullstackhero'
  description: 'fullstackhero ships agent-ready: a canonical AGENTS.md guide plus an .agents/ folder of rules, skills, and workflows so AI tools like Claude Code build…'
