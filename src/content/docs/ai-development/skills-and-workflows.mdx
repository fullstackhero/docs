...
description: 'The catalog of .agents skills (task recipes like add-feature, add-module, create-migration) and workflows (review and orchestration playbooks) that ship…'
