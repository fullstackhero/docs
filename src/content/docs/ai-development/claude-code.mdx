...
pageType: guide
seo:
  title: 'Developing fullstackhero with Claude Code'
  description: 'How to build features on the fullstackhero .NET starter kit with Claude Code: it auto-loads AGENTS.md, activates .agents skills from your request, runs…'
