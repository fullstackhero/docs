...
seo:
  title: 'fullstackhero vs Clean Architecture templates'
  description: 'How fullstackhero compares to Jason Taylor and Ardalis Clean Architecture templates. The short version: those templates ship an architecture, fullstackhero…'
