...
seo:
  ...
  description: 'fullstackhero ships two production React 19 + Vite 7 + TypeScript 5.7 frontends — clients/admin (operator console) and clients/dashboard (tenant-facing).'
