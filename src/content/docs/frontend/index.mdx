...
seo:
  ...
  description: 'fullstackhero ships two production React 19 + Vite 7 + TypeScript frontends — clients/admin (operator console) and clients/dashboard (tenant-facing).'
