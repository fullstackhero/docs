...
pageType: concept
seo:
  title: 'Per-tenant theming in fullstackhero — React dashboard brand'
  description: 'How the tenant dashboard pulls a TenantTheme from the Multitenancy module and applies per-tenant palette, brand assets, typography, and layout via CSS…'
