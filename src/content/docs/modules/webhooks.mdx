...
seo:
  ...
  description: 'How the Webhooks module wires tenant-scoped subscriptions, an open-generic IIntegrationEventHandler that fans every event to subscribers, HMAC-SHA256…'
