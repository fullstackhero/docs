...
The [multitenancy deep-dive](/docs/architecture/multitenancy-deep-dive/) covers when to use `IgnoreQueryFilters` versus `IgnoreNamedQueryFilter("SoftDelete")` for soft-delete-aware cross-tenant queries.
