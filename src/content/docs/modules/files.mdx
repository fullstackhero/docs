...
The S3 target is configured in the [Storage building block](/docs/building-blocks/storage/) - the Files module is the policy + lifecycle layer on top.
...
- [Storage building block](/docs/building-blocks/storage/) - the S3-compatible abstraction this module sits on top of.
