...
description: HybridCache (L1 in-memory + L2 Valkey or distributed memory) with OpenTelemetry instrumentation, stampede protection, and a shared multiplexer for DataProtection.
sidebar:
  label: Caching
  order: 5
pageType: reference
seo:
  ...
  description: 'How the Caching building block configures HybridCache (L1 in-memory + L2 Redis) with stampede protection, OpenTelemetry metrics, a shared Redis multiplexer…'
