...
| Piece | Type | Role |
|---|---|---|
| `FshWebApplicationFactory` | `WebApplicationFactory<Program>, IAsyncLifetime` | Owns the `postgres:17-alpine` + `quay.io/minio/minio:latest` Testcontainers, builds the in-process host, migrates + seeds |
