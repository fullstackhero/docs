...
seo:
  ...
  description: 'How fullstackhero shares Testcontainers + WebApplicationFactory + seeded tenants / users / catalog across the integration test project so per-test cost…'
...
| `RedisFixture` | `IAsyncLifetime` — Testcontainers Valkey 8 | The whole test project |
